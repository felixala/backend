...
public class UserController {
	...
	private ObjectMapper mapper; //esto ayuda a convertir un json en un objeto
	...
	public RestResponse saveOrUpdate(@RequestBody String userJson) throws JsonParseException, JsonMappingException, IOException{
		...
		if(!validate(user)){
			return new RestResponse(HttpStatus.NOT_ACCEPTABLE.value(), "Los datos obligatorios no estan diligenciados");
		}
	...
	public boolean validate(User user){
		...
		// StringUtils.trimToNull de Apache lang3 nos ayuda a resolver el problema de null y vacia de una info
		//nos ayuda a validar
